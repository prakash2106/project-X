...
Scenario Outline: verifying adactin login details with valid credentials. 
	...
	Then user should search hotel "<location>","<hotel>","<roomType>","<numberOfRooms>","<checkInDate>","<checkOutDate>","<adultsPerRoom>"and"<childrenPerRoom>" 
	...
	Then user should enter the book hotel"<firstName>","<lastName>","<billingAddress>","<creditCardNo>","<creditCardType>","<expiryMonth>","<expiryYear>"and"<cvv>" 
